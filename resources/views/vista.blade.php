...
<head>
	...
	<!-- Estilos CSS -->
	<link href="{{ asset('vista/css/CeEseEse.css') }}" rel="stylesheet">
	...
	<!-- JavaScript mío -->
	<script src="{{ asset('vista/js/JavaScript.js') }}"></script>
...
<body class="bg-gray-100 text-gray-900 tracking-wider leading-normal">
	...
	<div class="container w-full md:w-4/5 xl:w-3/5  mx-auto px-2">
		...
		<div id='recipients' class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
			...
			<table id="example" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
				...
				<tbody data-datos="{{ json_encode($datos) }}"></tbody>
	...
	<div id="crud-modal" tabindex="-1" aria-hidden="true" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-gray-900 bg-opacity-50">
		...
		<div class="relative p-4 w-full max-w-md max-h-full">
			...
			<div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
				...
				<form action="{{route('controlador.store')}}" method="POST" class="p-4 md:p-5">
					@csrf
	...
	<div id="deleteForm" class="hidden">
		<form action="{{route('controlador.destroy')}}" method="POST">
			@csrf
